...
function Thread({post ,display}) {
  if(display) display = true;

  // console.log(comments[0]?.author?.name , "author");
  ...
  @{post?.author?.username || 'Anonymous'}
        ...
        {/* Action Buttons */}
        {
          display ? (<div className="flex justify-around items-center px-6 py-3 border-t border-gray-800 text-gray-400">
